                        ...
                        <div class="row">
                            <div class="widget-area col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="widget widget-out-link clearfix">
                                   <aside>
                                <h3 class="widget-title"> <div class="company-logo">
                                    <img src="userResource/image/logo-img.png" alt="company-logo" height="45">
                                </div></h3>      
                            ...
                            <div class="widget-area col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="widget widget_nav_menu clearfix">
                                    ...
                                    <ul class="menu-footer-services">
                                        <li><a href="#">Our Catolougs</a></li>
                                        <li><a href="#">Our Events</a></li>
                                        <li><a href="#">Our Addons</a></li>
                                        <li><a href="#">Venue Searching</a></li>
                            ...
                            <div class="widget-area col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="widget widget-out-link clearfix ">
                                    ...
                                    <ul class="widget-post ttm-recent-post-list">
                                        <li>
                                            <a href="#"><img src="userResource/image/blog7.jpg" alt="post-img"></a>
                                            <a href="single-blog.html">Our Biggest Summer Meetup</a>
                                            <span class="post-date clearfix">August 1, 2018</span>
                                        </li>
                                        <li>
                                            <a href="#"><img src="userResource/image/blog3.jpg" alt="post-img"></a>
