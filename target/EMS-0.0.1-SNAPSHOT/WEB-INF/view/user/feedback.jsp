...
<link rel="stylesheet" type="text/css" href="userResource/css/star.css">
...
<fieldset class="rating">
    ...
    <input type="radio" id="star1" name="rating" value="1" /><label class = "full" for="star1" title="Sucks big time - 1 star"></label>
											...
											<p class="comment-form-comment">
												<textarea id="comment" placeholder="About Your Feedback"
												...
												<li>
													<div class="comment-body">
														<div class="comment-author vcard">
															<img src="userResource/image/blog-comment-01.jpg"
																class="avatar" alt="comment-img">
														</div>
														<div class="comment-box">
															<div class="comment-meta commentmetadata">
																<cite class="ttm-comment-owner">User Name</cite> <a href="#">July
																	24, 2018 at 11:33 am</a>
															</div>
															...
															<div class="reply">
																...
																<!----------- Feedback Stars loop Star Here ------------->
																	...
																	<i class="fa fa-star" style="color: #8068e0;"></i>
