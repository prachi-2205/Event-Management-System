                ...
                <div class="container">
                    ...
                    <div class="breadcrumb-wrapper">
                        <div class="container">
							...
							<span class="ttm-textcolor-white">&nbsp;&nbsp; AboutUs</span>
						</div>
                    </div>
                </div> 
            </div>
                    ...
                    <div class="row text-center">
                        <div class="col-lg-12">
                            <div class=" section-title clearfix">
                                <h4>WELCOME TO</h4>
                                <h2 class="title">About Planwey</h2>
                                <div class="title-img"><img src="<%=request.getContextPath()%>/userResource/image/ds-1.png" alt="underline-img"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="ttm-tabs element-tab-style-horizontal width-shape-line clearfix">
                                ...
                                <ul class="tabs connect-tabs clearfix mb-20">
                                    ...
                                    <li class="tab"><a href="#">Honor &amp; Awards</a></li>
                                </ul>
                                    ...
                                    <div class="content-inner">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6">
                                                <div class="mb-30">
                                                    <img class="img-fluid" src="<%=request.getContextPath()%>/userResource/image/tab1.jpg" alt="image">
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-lg-6">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            ...
                            <img src="<%=request.getContextPath()%>/userResource/image/col-bgimage-3.jpg" class="ttm-equal-height-image" alt="bg-image">
                        </div>
                ...
                <div class="container">
                    <div class="row text-center">
                        <div class="col-lg-12">
                            <div class=" section-title clearfix">
                                <h4>SEE OUR BEST</h4>
                                <h2 class="title">Planner Latest Team</h2>
                                <div class="title-img"><img src="<%=request.getContextPath()%>/userResource/image/ds-1.png" alt="underline-img"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <a href="team-details.html">
                                        <img class="img-fluid" src="<%=request.getContextPath()%>/userResource/image/team-img2.jpg" alt="image">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <a href="team-details.html">
                                        <img class="img-fluid" src="<%=request.getContextPath()%>/userResource/image/team-img1.jpg" alt="image">
                                    </a>
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title">
                        ...
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <a href="team-details.html">
                                        <img class="img-fluid" src="<%=request.getContextPath()%>/userResource/image/team-img3.jpg" alt="image">
                                    </a>
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title">
