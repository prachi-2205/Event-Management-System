...
<%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
							...
							<article class="post ttm-blog-classic">
								...
								<div class="ttm-blog-classic-content single-blog">
									...
									<div class="comment-respond">
										...
										<f:form action="saveComplain" method="post" id="commentform"
											class="comment-form" novalidate="" modelAttribute="ComplainVO" onsubmit="return viewComplain()">

											<p class="comment-form-author">
														<f:input path="complainsubject" id="complainsubject" placeholder="Subject" name="complainsubject" type="text" value="" size="30" aria-required="true"/>
											</p>

											<p class="comment-form-comment">
												<f:textarea  placeholder="About Your Complaint"
													 cols="45" rows="8" aria-required="true" path="complaindescrption" name="complaindescrption" id="complaindescrption"></f:textarea>
											</p>
											<p class="form-submit">
													...
													<div class="comment-body">
														...
														<div class="comment-box">
															<div class="comment-meta commentmetadata">
																<cite class="ttm-comment-owner">${i.loginVO.username}</cite> 
																<span>${i.complainsubject}</span>
															</div>
															<div class="author-content-wrap">
																<p>${i.complaindescrption}</p>
															</div>
															<div class="reply">
																<span class="mr-3">
																
																
																	<span href="">${i.complaindate}</span>
	...
	<!-- Validation Js -->
		...
		<script src="<%=request.getContextPath()%>/userResource/js/validation/viewComplai
		n.js"></script>
		<!-- -------------------------  -->
</body>
</html>