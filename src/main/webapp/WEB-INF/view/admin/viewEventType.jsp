...
<title>Admin | View Event Type</title>
<!-- General CSS Files -->
												...
												<tbody>
													<c:forEach items="${eventTypeList}" var="i" varStatus="j">
														<tr>
															...
															<td>${i.eventtype}</td>
															<td><a
															href="<%=request.getContextPath()%>/documents/eventType/${i.fileName}"
														...
														<a
															...
															<td>${i.eventtypedescription}</td>
															<td><a href="editEventType?id=${i.id}"> <i
																	class="fa fa-edit" style="font-size: 20px;"></i>
															</a> <a href="deleteEventType?id=${i.id}"> <i
																	class="fas fa-trash-alt"
																	style="color: #f44343; font-size: 20px; margin-left: 15px;"></i>
															</a></td>
														</tr>
													</c:forEach>
